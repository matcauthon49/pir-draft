...
int main() {
    ...
    if(entry_size>bitlength) {
        ...
        // std::cout<<"Degree: "<<NTL::deg(irredpol)<<"\n";
    ...
    // std::ofstream myfile("entry0.txt");
    std::cout<<"P_0: "<<databaseB[3]<<std::endl;
    ...
    // std::ofstream myfile("entry0.txt", std::ios::app);
    // myfile<<icp0.index.value<<std::endl;
    // for(int i=0; i<8; i++)
